...
func TestLibraryIntegration(t *testing.T) {
	...
	t.Run("Basic Download", func(t *testing.T) {
		...
		_, err := gdl.Download(ctx, server.URL, tempFile)
		if err != nil {
	...
	t.Run("Download with Options", func(t *testing.T) {
		...
		_, err := gdl.DownloadWithOptions(ctx, server.URL, tempFile, opts)
		if err != nil {
	...
	t.Run("Download to Writer", func(t *testing.T) {
		...
		_, err := gdl.DownloadToWriter(ctx, server.URL, &buf)
		if err != nil {
	...
	t.Run("Download to Memory", func(t *testing.T) {
		...
		data, _, err := gdl.DownloadToMemory(ctx, server.URL)
		if err != nil {
	...
	t.Run("Download with Resume", func(t *testing.T) {
		...
		_, err = gdl.DownloadWithResume(ctx, server.URL, tempFile)
		if err != nil {
	...
	t.Run("Get File Info", func(t *testing.T) {
		...
		info, err := gdl.GetFileInfo(ctx, server.URL)
		if err != nil {
...
func TestProgressCallback(t *testing.T) {
	...
	var progressUpdates []gdl.Progress
...
func TestErrorHandling(t *testing.T) {
	...
	t.Run("Invalid URL", func(t *testing.T) {
		_, err := gdl.Download(ctx, "://invalid-url", "test.txt")
		if err == nil {
	...
	t.Run("Network Error", func(t *testing.T) {
		_, err := gdl.Download(ctx, "http://192.0.2.0:1/test", "test.txt")
		if err == nil {

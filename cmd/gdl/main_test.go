...
func TestParseArgs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Set test args
			os.Args = append([]string{"gdl"}, tt.args...)
...
func TestRunFunction(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "version flag",
			args:         []string{"gdl", "--version"},
			expectedCode: 0,
		},
		{
			name:         "help flag",
			args:         []string{"gdl", "--help"},
			expectedCode: 0,
		},
		{
			name:         "no arguments",
...
func TestMainFunctionComponents(t *testing.T) {
	...
	t.Run("main function structure", func(t *testing.T) {
		...
		originalArgs := []string{"gdl", "--version"}
...
func TestRunFunctionAdvanced(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:         []string{"gdl", "-o", "test_output.txt", "--quiet", server.URL},
			expectedCode: 0,
		...
		},
		{
			...
			args:         []string{"gdl", "--verbose", "-o", "test_verbose.txt", server.URL},
			expectedCode: 0,
		...
		},
		{
			...
			args:         []string{"gdl", "--quiet", "not-a-valid-url"},
			expectedCode: 1,
			cleanup:      func() {},
		},
	}
...
func TestRunFunctionWithActualDownload(t *testing.T) {
	...
	t.Run("test run function path coverage", func(t *testing.T) {
		...
		go func() {
			...
			args := []string{"gdl", "--quiet", "invalid-protocol://invalid.url"}
...
func TestRunFunctionEdgeCases(t *testing.T) {
	t.Run("run_with_signal_simulation", func(t *testing.T) {
		...
		exitCode := run([]string{"gdl", "--version"})
		if exitCode != 0 {
	...
	t.Run("run_with_invalid_args", func(t *testing.T) {
		...
		exitCode := run([]string{"gdl", "--concurrent", "invalid"})
		if exitCode != 1 {
